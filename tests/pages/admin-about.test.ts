...
describe('admin About page', () => {
  ...
  beforeEach(() => {
    ...
    requestFetch.mockResolvedValue({ data: null, meta: {} })
  ...
  it('returns a non-null async-data result when the About post does not exist', async () => {
    ...
    expect(requestFetch).toHaveBeenCalledWith('/api/v1/admin/posts/by-slug/about')
  ...
  it('loads the edit view in a single by-slug request', async () => {
